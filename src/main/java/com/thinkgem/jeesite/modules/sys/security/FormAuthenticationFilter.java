...
public class FormAuthenticationFilter extends org.apache.shiro.web.filter.authc.FormAuthenticationFilter {
	...
	protected String getUsername(ServletRequest request) {
		...
		if (org.apache.commons.lang3.StringUtils.isBlank(username)){
			username = StringUtils.toString(request.getAttribute(getUsernameParam()), org.apache.commons.lang3.StringUtils.EMPTY);
		}
		return username;
	}
	...
	protected String getPassword(ServletRequest request) {
		...
		if (org.apache.commons.lang3.StringUtils.isBlank(password)){
			password = StringUtils.toString(request.getAttribute(getPasswordParam()), org.apache.commons.lang3.StringUtils.EMPTY);
		}
		return password;
	}
	...
	protected boolean isRememberMe(ServletRequest request) {
		...
		if (org.apache.commons.lang3.StringUtils.isBlank(isRememberMe)){
			isRememberMe = StringUtils.toString(request.getAttribute(getRememberMeParam()), org.apache.commons.lang3.StringUtils.EMPTY);
		}
