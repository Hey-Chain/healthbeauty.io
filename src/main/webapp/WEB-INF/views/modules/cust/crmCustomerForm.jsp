...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cust/crmCustomer/">客户信息列表</a></li>
		<li class="active"><a href="${ctx}/cust/crmCustomer/form?id=${crmCustomer.id}">客户信息<shiro:hasPermission name="cust:crmCustomer:edit">${not empty crmCustomer.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cust:crmCustomer:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="crmCustomer" action="${ctx}/cust/crmCustomer/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="wechat" htmlEscape="false" maxlength="32" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
